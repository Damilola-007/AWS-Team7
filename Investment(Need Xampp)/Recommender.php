...
<html lang="en">
  ...
  <div class=e1_74>
    ...
    <div class=e1_125><a href="Recommender.php"><span  class="e1_70">Recommender</span></a></div><span  class="e1_76">Evaluate Ideas</span><span  class="e1_77">Settings</span><span  class="e1_131">Messages</span>
    <div class=e1_71><span  class="e1_72">Logo</span></div>
  </div>
  <div class=e91_243><span  class="e1_68">Recommender</span>
    <div class="e1_75"></div>
  </div>
...
//Retrieve the ideas from database
  ...
  for($i=0; $i<$count; $i++)
  {
    ...
    {
      $AbstractCut = substr($Abstract, 0, 50) . "... <a href = 'Recommender.php?abreadmore'>Read more</a>";
    }

    if (strlen($Content) > 50) 
    {
      $ContentCut = substr($Content, 0, 50) . "... <a href = 'Recommender.php?conreadmore'>Read more</a>";
    }
    ...
    {
      echo "<td>".$Abstract."<br><a href = 'Recommender.php'>Show less</a></td>";
    }
    ...
    {
      echo "<td>".$Content."<br><a href = 'Recommender.php'>Show less</a></td>";
    }
...
//Retrieve data from the database and match it with search input
    ...
    if($count==0)
    {
      echo "<script>window.alert('No Results')
        window.location ='Recommender.php'</script>";
    }
else
{
?>
