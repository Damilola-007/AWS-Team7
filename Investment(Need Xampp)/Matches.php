...
//Retrieve the selected idea from database
  ...
  else
  {
    ...
    {
      $AbstractCut = substr($Abstract, 0, 50) . "... <a href = 'Matches.php?abreadmore'>Read more</a>";
    }

    if (strlen($Content) > 50) 
    {
      $ContentCut = substr($Content, 0, 50) . "... <a href = 'Matches.php?conreadmore'>Read more</a>";
    }
    ...
    {
      echo "<td>".$Abstract."<br><a href = 'Matches.php'>Show less</a></td>";
    }
    ...
    {
      echo "<td>".$Content."<br><a href = 'Matches.php'>Show less</a></td>";
    }
