...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2023 at 07:43 AM
...
(1, 'Damil', '$2y$10$yy9f/0UfVMW1oRd0M9e02O0dOP..ii1KUlf4V.qI0eD0wkBn/iL.q', 'damil@gmail.com', '2023-03-31 04:33:54', 'Damilola', 'Rasheed', '09823232323', 'Cambridge', 'Cambridge', 'Cambridge', 'Cambridge', 'CB1', 'Individual', 0.00, 'Stylish', 'For House', 'Short-term', 'Student', 2000.00, 'Conservative', 200.00, 500.00),
...
(3, 'Thant', '$2y$10$hdkz5nZQJ7P.pqMP4OP/b.peW46JmX8Y8EPRHRdLF6dNS42pD.8yO', 'thantclient@gmail.com', '2023-04-02 16:28:04', 'Thant', 'Aung', '09892832321', 'Cambridge', 'Cambridge', 'Cambridge', 'Cambridge', 'CB1 1PT', 'Joint', 0.00, 'Quality investing', 'For Laptop', 'Long-term', 'Student', 1000.00, 'Aggressive', 50.00, 500.00);
...
(4, 'Digital &amp; Cultural and Creative Sectors', 'Equity', 'Investments that contribute to the strengthening of the EUâ€™s competitiveness, digital independence and strategic autonomy, with a focus on data, communications technologies, services and products that facilitate the digital transition and address societal challenges', '2023-03-25', 'Avaliable', 600, 1);
...
(1, 'Thant Thu Aung', '$2y$10$J1M.AHSudFp5qAw7.HVkKu4dqJ9NGfUWLqQU8/ojA6l43qoSq/4G2', 'thant@gmail.com', '122323232', 'http://xampp.com', 'Thant Thu Aung', 'Anglia Ruskin', 'Web development', 'None', 'Anglia Ruskin'),
...
(1, 'Adeyinka', '$2y$10$raTEL/5kW/tIM3NycxKP3uOVMj91RMR1wegbXUWfnn8eGvnqTCjqq', 'rm@gmail.com', 'I am Oyeyemi Adeyinka and I am mainly a tester for this website.', '0989899898', 'Cambridge'),
...
--
ALTER TABLE `product_idea_creator`
  MODIFY `Creator_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `relationship_manager`
--
ALTER TABLE `relationship_manager`
  MODIFY `ManagerID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
