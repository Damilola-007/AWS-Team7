...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2023 at 09:48 AM
...
INSERT INTO `client` (`UserID`, `UserName`, `Password`, `Email`, `Created_at`, `First_Name`, `Last_Name`, `Phone_Number`, `Address`, `City`, `State`, `Country`, `Postal_code`, `Account_Type`, `Account_Balance`, `Investment_style`, `Investment_goal`, `Investment_horizon`, `Employment_status`, `Annual_income`, `Risk_tolerance`, `Net_worth`, `Investment_amount`) VALUES
(1, 'Damil', '$2y$10$WKoenwXQ/4Qjl/Zu1Dq1MuTZu0Cj93hJhH2Fjze6SWUknNZw85Rme', 'damil@gmail.com', '2023-03-31 04:33:54', 'Damilola', 'Rasheed', '09823232323', 'Cambridge', 'Cambridge', 'Cambridge', 'Cambridge', 'CB1', 'Individual', 0.00, 'Stylish', 'For House', 'Short-term', 'Student', 2000.00, 'Conservative', 200.00, 500.00),
(2, 'Adeyinka', '$2y$10$UrRDFrRO8xm74KX/kjLSNeV8u1EHHyKGr0O5Jhwi/4LBXzOfh3bRC', 'adeyinka@gmail.com', '2023-03-31 04:39:18', 'Oyeyemi', 'Adeyinka', '092932999323', 'Cambridge', 'Cambridge', 'Cambridge', 'Cambridge', 'CB1', 'Corporate', 0.00, 'Growth investing', 'For Car', 'Short-term', 'Student', 1500.00, 'Conservative', 500.00, 1000.00),
(3, 'Thant', '$2y$10$H33DR3GJ5ot5vSkn25jfEuF0dWYP7f8bA.UjiBYjsdT6x6SpX1Zj6', 'thantclient@gmail.com', '2023-04-02 16:28:04', 'Thant', 'Aung', '09892832321', 'Cambridge', 'Cambridge', 'Cambridge', 'Cambridge', 'CB1 1PT', 'Joint', 0.00, 'Quality investing', 'For Laptop', 'Long-term', 'Student', 1000.00, 'Aggressive', 50.00, 500.00);

-- --------------------------------------------------------

--
-- Table structure for table `client_rm_relations`
--

CREATE TABLE `client_rm_relations` (
  `RelationsID` int(20) NOT NULL,
  `UserID` int(20) NOT NULL,
...
INSERT INTO `investment_products` (`ProductID`, `Product_Name`, `Product_Type`, `Description`, `Product_added_date`, `Status`, `Product_Price`, `Creator_ID`) VALUES
(1, 'U.S Treasury Security', 'Bonds', 'U.S. Treasury securities (&quot;Treasuries&quot;) are issued by the federal government and, because they&#039;re backed by the &quot;full faith and credit&quot; of the U.S. government, are considered to be among the safest investments you can make. This means that, come what may (e.g., recession, inflation, war), the U.S. government is expected to repay its bondholders. Theyâ€™re also among the most liquidâ€”or actively tradedâ€”investments in the world.', '2023-03-20', 'Avaliable', 1500, 1),
(2, 'Capital Markets Union', 'Equity', 'Investments supporting capital markets and improving access to finance-based equity and debt investments that support the growth of European enterprises, diversification of sources of financing, and strengthening the solvency of enterprises by sharing risk with private investors.', '2023-03-23', 'Avaliable', 1000, 1),
(3, 'Climate and Environmental Solutions', 'Equity', 'These investments contribute to the EU Green Deal and support a transition to an EU climate-neutral economy based on sustainable development, a reduction in dependence on fossil fuels, sustainable management of natural resources, food security and enhanced climate resilience, among other goals.', '2023-03-02', 'Not Avaliable', 500, 1),
(4, 'Digital &amp; Cultural and Creative Sectors', 'Equity', 'Investments that contribute to the strengthening of the EUâ€™s competitiveness, digital independence and strategic autonomy, with a focus on data, communications technologies, services and products that facilitate the digital transition and address societal challenges', '2023-03-25', 'Avaliable', 300, 1);
...
--
-- Dumping data for table `product_idea_creator`
--

INSERT INTO `product_idea_creator` (`Creator_ID`, `Creator_Name`, `Password`, `Email`, `Phone_Number`, `Website`, `LinkedIn`, `Industry`, `Skills`, `Work_Experience`, `Education`) VALUES
(1, 'Thant Thu Aung', '$2y$10$ENjHbW1vk7uPCI.BEJ56UO6WbsfP5epAowNiC4jFhtmeNdrZg8sLe', 'thant@gmail.com', '122323232', 'http://xampp.com', 'Thant Thu Aung', 'Anglia Ruskin', 'Web development', 'None', 'Anglia Ruskin'),
(2, 'Damil', '$2y$10$SzPjeOd99kV9PEweUh5cNu3hZZcmqIqwsyN3EIfjuGv7bOaR8SOOW', 'damil123@gmail.com', '09923923', 'http://xampp.com', 'Damil', 'Anglia Ruskin', 'Web Design', 'Part-time jobs', 'Anglia Ruskin');
...
INSERT INTO `relationship_manager` (`ManagerID`, `Manager_Name`, `Password`, `Email`, `Biography`, `Phone_Number`, `Location`) VALUES
(1, 'Adeyinka', '$2y$10$uLLrXnuOBTWJG8i7qGcOfuGE5vahHK.V2/7bZ/mjnEFwmnRfUrLEW', 'rm@gmail.com', 'I am Oyeyemi Adeyinka and I am mainly a tester for this website.', '0989899898', 'Cambridge'),
(2, 'Damil', '$2y$10$jcoHZJBoK3E12HKmC2JfqOgHy0IQCxpw97v3kMxfIawkHKckdGZIa', 'damilrm@gmail.com', 'I am Damiola Rasheed. I have developed this website design', '0988923222', 'Cambridge'),
(3, 'Thant', '$2y$10$srd0cVd4DggwLPMEyKPWd.Ysn4A/tzRDkhD5P5DN7zbAhucqgjmxG', 'thantrm@gmail.com', 'I am Thant Thu Aung and I am backend developer for this website.', '0988923222', 'Cambridge');
...
--
-- Indexes for table `client_rm_relations`
--
ALTER TABLE `client_rm_relations`
  ADD PRIMARY KEY (`RelationsID`),
...
--
-- AUTO_INCREMENT for table `client_rm_relations`
--
ALTER TABLE `client_rm_relations`
  MODIFY `RelationsID` int(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `investment_ideas`
--
ALTER TABLE `investment_ideas`
  MODIFY `Ideas_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `product_idea_creator`
  MODIFY `Creator_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `client_rm_relations`
--
ALTER TABLE `client_rm_relations`
  ADD CONSTRAINT `client_rm_relations_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `client` (`UserID`),
  ADD CONSTRAINT `client_rm_relations_ibfk_2` FOREIGN KEY (`ManagerID`) REFERENCES `relationship_manager` (`ManagerID`);
