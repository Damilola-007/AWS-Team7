...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2023 at 03:32 AM
...
(1, 'U.S Treasury Security', 'Bonds', 'U.S. Treasury securities (&quot;Treasuries&quot;) are issued by the federal government and, because they&#039;re backed by the &quot;full faith and credit&quot; of the U.S. government, are considered to be among the safest investments you can make. This means that, come what may (e.g., recession, inflation, war), the U.S. government is expected to repay its bondholders. Theyâ€™re also among the most liquidâ€”or actively tradedâ€”investments in the world.', '2023-03-20', 'Avaliable', '', 1),
(2, 'Capital Markets Union', 'Equity', 'Investments supporting capital markets and improving access to finance-based equity and debt investments that support the growth of European enterprises, diversification of sources of financing, and strengthening the solvency of enterprises by sharing risk with private investors.', '2023-03-23', 'Avaliable', '', 1),
(3, 'Climate and Environmental Solutions', 'Equity', 'These investments contribute to the EU Green Deal and support a transition to an EU climate-neutral economy based on sustainable development, a reduction in dependence on fossil fuels, sustainable management of natural resources, food security and enhanced climate resilience, among other goals.', '2023-03-02', 'Not Avaliable', '', 1),
(4, 'Digital &amp; Cultural and Creative Sectors', 'Equity', 'Investments that contribute to the strengthening of the EUâ€™s competitiveness, digital independence and strategic autonomy, with a focus on data, communications technologies, services and products that facilitate the digital transition and address societal challenges', '2023-03-25', 'Avaliable', '', 1);
...
INSERT INTO `relationship_manager` (`ManagerID`, `Manager_Name`, `Password`, `Email`, `Biography`, `Photo_URL`, `Phone_Number`, `Location`) VALUES
