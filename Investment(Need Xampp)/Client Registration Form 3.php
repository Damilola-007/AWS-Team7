...
<body>
  <div class=e440_250>
    ...
    <div class=e440_270>
      ...
      <div class=e440_272><button type= "submit" id="clientregister" name="clientregister" formmethod="post"><span  class="e440_273">SUBMIT</span></button></div>
      <div class=e440_274>
        <div class=e440_275><label for="username"><span  class="e440_276">UserName</span></label>
          <div>
            <input class="e440_277" type="text" name="username" id="username" required>
          </div>
        </div>
        <div class=e440_278><label for="occupation"><span  class="e440_279">Occupation </span></label>
           <div>
            <input class="e440_280" type="text" name="occupation" id="occupation" required>
          </div>
        </div>
      ...
      <div class=e440_288><label for="investment_goal"><span  class="e440_289">Investment Goal</span></label>
        <div>
          <input class="e440_290" type="text" name="investment_goal" id="investment_goal" required>
        </div>
        <!--
      ...
      <div class=e440_291><span  class="e440_292">Risk Tolerance</span>
        <div>
          <select class="e440_293" name="risk_tolerance" id="risk_tolerance" required>
            <option value=""></option>
      ...
      <div class=e440_294><label for="investment_style"><span  class="e440_295">Investment Style</span></label>
        <div>
          <input class="e440_296" type="text" name="investment_style" id="investment_style" required>
        </div>
      </div>
      <div class=e440_297><label for="annual_income"><span  class="e440_298">Annual Income</span></label>
        <div>
          <input class="e440_299" type="number" name="annual_income" id="annual_income" required>
        </div>
      </div>
      <div class=e440_300><span  class="e440_301">Account Type</span>
        <div>
          <select class="e440_302" name="account_type" id="account_type" required>
            <option value=""></option>
      ...
      <div class=e440_304><label for="investment_amount"><span  class="e440_305">Investment Amount</span></label>
        <div>
          <input class="e440_306" type="number" name="investment_amount" id="investment_amount" required>
        </div>
      </div>
      <div class=e440_307><label for="net_worth"><span  class="e440_308">Net worth</span></label>
        <div>
          <input class="e440_309" type="number" name="net_worth" id="net_worth">
        </div>
      </div>
      <div class=e440_313><span  class="e440_314">Investment Horizon</span>
        <div>
          <select class="e440_315" name="investment_horizon" id="investment_horizon" required>
            <option value=""></option>
