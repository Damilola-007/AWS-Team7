...
Client Registration, Idea Creator Registration, CRUD Product, Idea, RM Registration, RM dashboard, Client, RM and Idea Creator being able to login and log out, Client dashboard
