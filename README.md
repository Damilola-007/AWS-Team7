...
Client Registration, CRUD Product, Idea, Idea Creator Registration, RM dashboard, Client, RM and Idea Creator being able to login and log out
...
Note: All the hashed password in the database translates to "Test1234" except the Product Idea Creator named "Thant Thu Aung"
