...
If there are any errors after you follow the instruction, you will have to enable "extension=intl" by removing ";" in front of it or add it if it is not there from php.ini which can be mostly found in C:\xampp\php\.
